  ...
  return (
    <>
      <aside
        ...
        aria-label="Sidebar"
      >
        <div class="h-full px-1 py-2 overflow-y-auto bg-gray-50 dark:bg-gray-800 mb-10 p-10">
          <div></div>
          <ul class="space-y-2 font-medium m-3">
            <li class="mt-10">
              <a
                href="/account-management"
                class="flex items-end p-1  text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group"
              >
                <svg
              ...
              <a
                href="#"
                class="flex items-end p-1 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group mb-10 "
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
      ...
      <div class="p-2 sm:ml-48 items-center">
